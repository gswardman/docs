...
<CardGroup cols={2}>
  ...
  <Card title="For Charities" icon="heart" href="/for-nonprofits/get-found-by-ai">
    Get your charity found by AI, and a free AI audit
  </Card>
  <Card title="Agent Feedback" icon="comments" href="/for-agents/feedback">
    Report bugs and wrong data at m/giveready on Moltbook
  </Card>
</CardGroup>
